...
class PersonController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GoyGoyEduPortalBundle:Person')->findAll();
     ...
     * @Method("POST")
     * @Template("GoyGoyEduPortalBundle:Person:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GoyGoyEduPortalBundle:Person')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("GoyGoyEduPortalBundle:Person:edit.html.twig")
     */
